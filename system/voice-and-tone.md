...
### 2. Start with their problem, not our capability
...
- **Best-in-class**
- **Industry-leading**
- **Robust** (when describing software)
...
- **Empower**
- **Unlock value**
- **Digital transformation** (say what's actually changing)
- **Stakeholder alignment** (say "getting everyone on the same page")
- **North star** (say "the goal")

---

## Personal voice (define your own)
